...
with tab2:
    ...
    if not st.session_state.smiles_cache:
        st.warning("⚠️ Access Gated: Provide a valid pure SMILES sequence in Phase 1 to unlock the modification dashboard. Ensure you clicked 'Load Ligand Structure'.")
    else:
